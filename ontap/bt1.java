...
public class bt1 {
	public static int splitFileByKeyKeyWorlds(String srcFile, String destFile, String[] keywords) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] keywords = { "Tan", "Nhat", "Nhan" };
		System.out.println(splitFileByKeyKeyWorlds(srcFile, destFile, keywords));
	}
}
